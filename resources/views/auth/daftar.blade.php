                        ...
                        <div class="col-lg-12">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center text-white my-4">Daftar KRATEOS</h3>
                                </div>
                                <div class="card-body">
                                    <form action="#" method="POST">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input class="form-control @error('name') is-invalid @enderror"
                                                id="inputName" type="text" name="name" placeholder="Nama Lengkap"
                                        ...
                                        <button type="submit" class="btn btn-primary w-100 mt-4 mb-3">Daftar</button>
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="{{ route('auth.index') }}">Sudah punya akun? Login
                                                sekarang!</a>
                                        </div>
